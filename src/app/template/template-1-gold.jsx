...
import ProfilMempelai from "@/components/paket/gold/ProfileMempelai";
...
export default function Template1Gold({ id, data }) {
  ...
  const [theme, setTheme] = useState(dataMempelai?.temaWarna || "royal");
      ...
      {!opened && (
        ...
        >
          ...
          <div className="absolute inset-0">
            <Image
              src={dataMempelai?.fotoSampul[0] || "/images/tmp.jpg"}
        ...
        <div className="relative z-10 pb-24">
          ...
          >
            ...
            <p className="mt-4 text-xs text-gray-400">
              © {new Date().getFullYear()} {dataMempelai?.namaLengkapPria} &{" "}
              {dataMempelai?.namaLengkapWanita} Wedding
            </p>
          </motion.footer>
        </div>
      )}
